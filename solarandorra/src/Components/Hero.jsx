...
export const Hero = () => {
  return (
    ...
    <div className="h-screen w-full max-w-7xl md:mx-auto pt-24 md:pt-0 flex flex-col md:flex-row "  >
        ...
        <h2 className="w-[90%] lg:w-full mx-auto lg:mx-0 text-center text-4xl md:text-5xl 2xl:text-6xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-cyan-800 to-red-500 py-2"><span className="">Energia Renovable.</span>Tu Hogar.Tranquilidad.</h2>
