...
export const Instalacion = () => {
  return (
    <div className="w-full h-full md:h-screen bg-slate-200">
    <div className="h-full w-full max-w-7xl pt-10 md:mx-auto" >
      <h4 className=" text-green-500 text-md font-bold text-left md:text-4xl p-4">El proceso</h4>
        <h3 className="text-2xl md:text-5xl font-bold text-left p-4">¿Cómo es una instalación de placas solares en una vivienda?</h3>
